...
const Demo2 = (props) => {
    ...
    useEffect(() => {
        if (txt?.image) {
            txt.image.muted = true;
            txt.image.loop = true;
            txt.image.play().catch(console.error);
        }
    }, [txt]);

    // Apply the video texture to the monitor screen
    useEffect(() => {
        if (nodes && nodes.Screen) {
            nodes.Screen.material.map = txt;
            nodes.Screen.material.needsUpdate = true;
        }
    }, [nodes, txt]);
        ...
        <group ref={group} {...props} dispose={null}>
            ...
            <group scale={0.01}>
                <mesh
                    castShadow
                    receiveShadow
                    geometry={nodes.Object_782_OnTheFly_bg_0.geometry}
